 ...
 */
    ...
    'module_ldap_LdapCheckGetUsersList' => '指定されたアクセス パラメーターとフィルターを使用して、LDAP / AD にクエリを実行し、同期するユーザーのリストを取得します。',
    ...
    'module_ldap_LdapManualSyncManual' => 'ボタンをクリックすると、指定したドメイン コントローラーと MikoPBX の間でユーザーが同期されます。',
    ...
    'module_ldap_EnableAutoSync' => 'スケジュールされた同期を有効にする (1 時間ごと)',
