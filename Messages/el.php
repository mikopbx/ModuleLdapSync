 ...
 */
    ...
    'module_ldap_LdapCheckGetUsersList' => 'Χρησιμοποιώντας τις καθορισμένες παραμέτρους πρόσβασης και τα φίλτρα, θα κάνουμε ερώτημα LDAP / AD και θα λάβουμε μια λίστα χρηστών για συγχρονισμό',
    ...
    'module_ldap_LdapManualSyncManual' => 'Κάνοντας κλικ στο κουμπί θα συγχρονιστούν οι χρήστες μεταξύ του καθορισμένου ελεγκτή τομέα και του MikoPBX',
    ...
    'module_ldap_EnableAutoSync' => 'Ενεργοποίηση προγραμματισμένου συγχρονισμού (κάθε ώρα)',
