 ...
 */
    ...
    'module_ldap_VerifyCertificate' => 'Validate server certificate',
    'module_ldap_CaCertificate' => 'CA certificate bundle (PEM)',
    'module_ldap_CaCertificateHint' => 'Paste the PEM-encoded CA certificate used to sign the LDAP server. Multiple certificates (intermediate + root) may be concatenated. Leave empty to use the system trust store.',
    'module_ldap_InsecureTlsWarning' => 'LDAPS is enabled but certificate validation is off — traffic is encrypted yet the server identity is not verified. Turn on validation and provide the CA certificate for a secure setup.',
    'module_ldap_InvalidPemCert' => 'The provided CA certificate is not a valid PEM block.',
    'module_ldap_TestBindHeader' => 'Test LDAP bind',
    'module_ldap_TestBindHint' => 'Verifies that the server is reachable and the administrative credentials above authenticate successfully. No data is read or modified.',
    'module_ldap_TestBindButton' => 'Test bind',
    'module_ldap_TestBindSuccess' => 'LDAP bind successful.',
    'module_ldap_TestBindFailure' => 'LDAP bind failed',
    'module_ldap_TabCertificate' => 'Certificate',
    'module_ldap_tt_serverName_header' => 'Transport modes',
    'module_ldap_tt_serverName_plain' => 'unencrypted LDAP, port 389.',
    'module_ldap_tt_serverName_starttls' => 'LDAP on port 389 upgraded to TLS.',
    'module_ldap_tt_serverName_ldaps' => 'LDAP over TLS from the first byte, port 636.',
    'module_ldap_tt_adminLogin_header' => 'Bind login format',
    'module_ldap_tt_adminLogin_desc' => 'Active Directory accepts any of these forms for the bind login:',
    'module_ldap_tt_adminLogin_note' => 'LDAPS proxies in a DMZ often reject short forms with "Invalid DN syntax" — use the full DN in that case.',
    'module_ldap_tt_verify_header' => 'Certificate validation',
    'module_ldap_tt_verify_desc' => 'When enabled, self-signed, expired or CA-mismatched certificates are rejected. Provide the signing CA on the Certificate tab.',
    ...
    'module_ldap_tt_updateAttr_avatar' => 'avatar photo',
    'module_ldap_tt_updateAttr_sip' => 'SIP password',
    'module_ldap_tt_updateAttr_note' => 'The bind account must have write permission on the matching attributes.',
];
