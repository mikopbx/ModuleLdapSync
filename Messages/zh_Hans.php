 ...
 */
    ...
    'module_ldap_LdapCheckGetUsersList' => '使用指定的访问参数和过滤器，我们将查询LDAP / AD并获取要同步的用户列表',
    ...
    'module_ldap_LdapManualSyncManual' => '单击该按钮将同步指定域控制器和 MikoPBX 之间的用户',
    ...
    'module_ldap_EnableAutoSync' => '启用计划同步（每小时）',
